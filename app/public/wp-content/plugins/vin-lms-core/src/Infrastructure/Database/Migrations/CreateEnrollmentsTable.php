 ...
 * WordPress migration to create the LMS enrollments table.
...
final class CreateEnrollmentsTable
{
    /**
    ...
    public static function run(): void
    {
        ...
        // dbDelta requires specific SQL formatting: keys and indexes defined with KEY/UNIQUE KEY
